...
<script>
    ...
    function openForgotPasswordModal(event) {
        ...
        document.getElementById('forgotModalOverlay')?.classList.add('active');
        emailEl?.focus();
    }

    function closeForgotPasswordModal() {
        document.getElementById('forgotModalOverlay')?.classList.remove('active');
    }

    function resetForgotModal() {
        forgotStep = 'email';
        const els = {
            emailEl: document.getElementById('forgotEmail'),
            otpEl: document.getElementById('forgotOtp'),
            pwEl: document.getElementById('forgotPassword'),
            pwcEl: document.getElementById('forgotPasswordConfirm'),
            otpWrap: document.getElementById('forgotOtpWrap'),
            pwWrap: document.getElementById('forgotPasswordWrap'),
            reqWrap: document.getElementById('forgotPasswordRequirements'),
            desc: document.getElementById('forgotDesc'),
            emailBtn: document.getElementById('forgotEmailVerifyBtn'),
            otpBtn: document.getElementById('forgotVerifyOtpBtn'),
        ...
        if (els.otpWrap) els.otpWrap.classList.remove('active');
    ...
    function validateForgotPasswordRequirements() {
        ...
        document.getElementById('forgotReqLower')?.classList.toggle('valid', lower);
        document.getElementById('forgotReqLen')?.classList.toggle('valid', len);
        document.getElementById('forgotReqUpper')?.classList.toggle('valid', upper);
        document.getElementById('forgotReqNum')?.classList.toggle('valid', num);
    ...
    async function verifyForgotOtp() {
        ...
        if (err) err.style.display = 'none';
        document.getElementById('forgotVerifyOtpBtn').style.display = 'none';
        document.getElementById('forgotOtpWrap').style.display = 'none';
    ...
    async function handleForgotReset() {
        ...
        try {
            ...
            const result = await parseForgotResponse(response);
            if (!response.ok) throw new Error(result.message || 'Failed to reset password. Please try again.');
